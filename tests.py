...
import unittest
import sqlite3
from analyse import text_analyse

class MyTests(unittest.TestCase):

    def test_neutraal(self):
         self.assertTrue(text_analyse("another day on the interwebz") == 0)

    def test_negatief(self):
         self.assertTrue(text_analyse("i really Hate python, god damn") < 0)

    def test_positief(self):
         self.assertTrue(text_analyse("This is the best day ever!") > 0)
